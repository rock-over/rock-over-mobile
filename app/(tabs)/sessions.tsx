...
export default function SessionsScreen() {
  ...
  const handleCardPress = (session: ClimbingSession) => {
    console.log('🎯 [Sessions] Opening session details for:', {
      id: session.id,
          ...
          >
            ...
            <View style={successStyles.buttonStack}>
              <TouchableOpacity 
                ...
                onPress={handleBackToHome}
              >
                <Text style={[successStyles.buttonText, successStyles.primaryButtonText]}>Back to Sessions</Text>
              </TouchableOpacity>
        ...
        <View style={styles.viewToggleContainer}>
          <View style={styles.viewToggleContent}>
            ...
            <View style={styles.titleContainer}>
              <Text style={styles.titleText}>Your sessions</Text>
